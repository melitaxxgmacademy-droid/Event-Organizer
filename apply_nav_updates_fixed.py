...
venue_pattern = re.compile(r'<li>\s*<a href="venue\.html"(?:\s+class="active")?>\s*Lokasi\s*</a>\s*</li>', re.IGNORECASE)
speaker_pattern = re.compile(r'<li>\s*<a href="speaker-details\.html"(?:\s+class="active")?>\s*Detail Pembicara\s*</a>\s*</li>\s*', re.IGNORECASE)
...
for path in html_files:
    ...
    text = venue_pattern.sub('<li><a href="blog.html">Blog</a></li>', text)
